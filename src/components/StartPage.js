          ...
          <Row>
            <Col className={styles.about_me}>
              <div className={styles.content}>
                ...
                <h1>
                  <p>
                    <span className="highlight">Abi</span>(sade),
                  </p>
                </h1>
                <h3>
                ...
                <br />
                <a href="mailto:a.ogunwoolu@outlook.com">
                  ...
                  <Row className={styles.social_bar}>
                    <Col>
                      <FaGithub
                        className="icon"
                        onClick={() =>
                          window.open("https://github.com/aogunwoolu")
                        }
                        size={28}
                      />
                    </Col>
                    ...
                    <Col>
                      <AiFillLinkedin
                        ...
                        onClick={() =>
                          window.open(
                            "https://www.linkedin.com/in/abisade-ogunwoolu-0bb804155/"
                          )
                        }
                        size={28}
                      />
